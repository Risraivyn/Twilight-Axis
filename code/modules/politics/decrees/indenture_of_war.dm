...
Заверено печатью Короны и печатью Маршала Великого Герцогства."}
	revoke_text = "Правитель сиих земель нарушил Военный контракт. Клятва воинов Герцогства аннулирована, и они свободны в выборе господина — и пусть помнят они, чья печать была срублена первой."
	restore_text = "Правитель сиих земель возобновил Военный контракт. Солдату обещано жалованье, и его клятва остается в силе — одно обязывает другое."
