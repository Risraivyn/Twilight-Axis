...
Заверено печатью %RULER_NAME%, Великого Герцога сиих земель, и да будет его имя прославлено вовеки."}
	revoke_text = "Слушайте, слушайте. Великий Герцог Азурии, сюзерен Кингсфилда, Блэкхолта, Солтвика, Розавуда, Женавы и Дафтсмарча, баннерет Бликкоста, Нортфорта и Лазурного Анклава, верный слуга Десяти Неделимых, сегодня отменил Великую хартию вольности. На подданных Герцогства вновь возлагаются привычные финансовые обязательства, а доходы Короны восстанавливаются в полном объеме. Пусть в летописи будет отражен пересмотр решения %RULER_NAME%."
