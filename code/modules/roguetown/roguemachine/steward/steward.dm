...
/obj/structure/roguemachine/steward/attack_hand(mob/living/user)
	...
	switch(current_tab)
		...
		if(TAB_FISCAL)
			...
			// Balances (two-column)
			contents += "<b><font color='#e6b327'>БАЛАНС</font></b>"
			contents += "<table width='100%' cellspacing='0' cellpadding='2'>"
			contents += "<tr><td>Казна</td><td align='right'><font color='#e6b327'>[snap["discretionary"]]m</font></td>"
			contents += "<td>Burgher Pledge</td><td align='right'><font color='#e6b327'>[snap["burgher_pledge"]]m</font></td></tr>"
			contents += "<tr><td>Кредит Короны</td><td align='right'>[snap["total_bank"]]m</td>"
			...
			contents += "<td>Налоги депозита</td><td align='right'><font color='#5cb85c'>[SStreasury.total_deposit_tax]m</font></td></tr>"
			...
			contents += "<td>Наград за голову</td><td align='right'><font color='#5cb85c'>[GLOB.azure_round_stats[STATS_REVENUE_HEADEATER_LEVY]]m</font></td></tr>"
			...
			contents += "<td>Экспортная пошлина</td><td align='right'><font color='#5cb85c'>[GLOB.azure_round_stats[STATS_REVENUE_EXPORT_DUTY]]m</font></td></tr>"
			...
			contents += "<b><font color='#c0b283'>ТОРГОВЛЯ</font></b>"
			contents += "<table width='100%' cellspacing='0' cellpadding='2'>"
			contents += "<tr><td>Экспорт из ямы</td><td align='right'><font color='#5cb85c'>[SStreasury.total_export]m</font></td>"
			contents += "<td>Импорт в яму</td><td align='right'><font color='#d9534f'>-[SStreasury.total_import]m</font></td></tr>"
			var/trade_bal = SStreasury.total_export - SStreasury.total_import
			var/trade_col = trade_bal >= 0 ? "#5cb85c" : "#d9534f"
			contents += "<tr><td>Баланс торговли</td><td align='right'><font color='[trade_col]'>[trade_bal]m</font></td>"
			contents += "<td>Объем производства</td><td align='right'>[SStreasury.economic_output]m</td></tr>"
			contents += "</table><br>"
			...
			contents += "<td>Казначейские Переводы</td><td align='right'><font color='#d9534f'>-[GLOB.azure_round_stats[STATS_DIRECT_TREASURY_TRANSFERS]]m</font></td></tr>"
